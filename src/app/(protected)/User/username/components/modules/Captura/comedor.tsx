...
import { useValidarComedor } from "@/hooks/hooksRegistro/useRegistro";
...
export default function Comedor() {
  ...
  const { fetchQuery, renderQueryComedor } = useValidarComedor(clearInput);
  ...
  return (
    ...
    >
      {/* Tarjeta principal */}
      <div className="relative w-full max-w-xl mt-6 bg-gray-100 rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 shadow-black">
        {/* Barra superior más gruesa */}
        <div className="h-4 bg-gradient-to-r from-green-600 to-red-600"></div>
        ...
        <div className="px-10 py-8">
          ...
          <div className="relative mb-8">
            <input
              ...
              className="w-full px-6 py-4 text-xl border-2 border-gray-300 rounded-xl focus:ring-3 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-center font-mono uppercase placeholder-gray-400"
              disabled={isLoading}
            />
            {isLoading && (
          ...
          <div className="min-h-32 bg-gray-50 rounded-xl p-6 border-2 border-gray-200 transition-all duration-200 text-lg">
            {renderQueryComedor || (
              <p className="text-gray-400 text-center py-6">
                Ingrese su identificación para ver los detalles de acceso
              </p>
            )}
          </div>
