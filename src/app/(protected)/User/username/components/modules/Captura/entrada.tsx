...
import { useValidarRegistro } from "@/hooks/hooksRegistro/useRegistro";
...
export default function Entrada() {
  ...
  const { fetchQuery, renderQuery } = useValidarRegistro(clearInput);
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full mt-6 max-w-xl bg-gray-100 rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 shadow-black ">
        {/* Barra superior  */}
        <div className="h-4 bg-gradient-to-r from-blue-500 to-sky-900"></div>
