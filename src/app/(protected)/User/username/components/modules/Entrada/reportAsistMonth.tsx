  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.post(
        "/api/Alumnos/Asistencia/reportAsistMonth",
        params
      );
        ...
        <div className="flex flex-wrap items-end gap-3 mb-6">
          ...
          <div className="w-auto h-10">
            <button
              onClick={fetchData}
              disabled={loading}
              className="h-full px-4 py-2 bg-gradient-to-r from-blue-700 to-blue-600 text-white rounded-md shadow hover:from-blue-600 
              hover:to-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-70"
            >
              {loading ? (
