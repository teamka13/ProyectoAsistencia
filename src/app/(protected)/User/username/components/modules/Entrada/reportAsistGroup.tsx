...
export function ReporteAsistenciaDiario() {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.post(
        "/api/Alumnos/Asistencia/reportAsistGroup",
        params
      );
  ...
  return (
    <div className="p-6 mt-6 max-w-7xl mx-auto bg-white rounded-lg shadow-sm border-l-4 border-blue-500">
      <div className="p-4 bg-blue-50 rounded-lg shadow-sm shadow-blue-700">
        {/* Encabezado */}
        <div className="flex items-center mb-6">
          <ClipboardCheck className="text-blue-600 mr-3 h-5 w-5" />{" "}
          {/* Icono de checklist */}
        ...
        <div className="mb-6">
          <input
            ...
            className="p-2 border-4 border-blue-300 rounded-lg w-full 
            focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all uppercase"
            value={search}
        ...
        <div className="flex flex-wrap items-end gap-3 mb-6">
          ...
          <div className="w-auto h-10">
            <button
              onClick={fetchData}
              disabled={loading}
              className="h-full px-4 py-2 bg-gradient-to-r from-blue-700 to-blue-600 text-white rounded-md shadow 
             hover:from-blue-600 hover:to-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 
             disabled:opacity-70"
            >
              {loading ? (
